...
\begin{abstract}
Online deliberation systems are well studied also from the domain of political science. The results however are less encouraging: both in terms of quality and the reach of the participation and reach online deliberation has not achieved the ideals set up by political scientists and practitioners. Even while these systems are well studied, the focus has been in the use of these systems and in a lesser degree in the development-phase. However, the design of these systems impacts the user behavior and therefore needs more rigorous analysis.

A combination of both human-computer interaction (HCI) and political science will be able to conduct this kind of analysis: the questions related to system design and impacts of them are well known in HCI, whereas the concepts used to frame the research origin from political science. As in HCI, the empirical and experimental approach can be applied in online deliberation domain, and furthermore, by using this approach a set of design principles can be presented for practitioners and for scholars as a framework for analysis and examination on the impacts -- and interplay -- of social structures and technical systems on deliberation. Examples of experimental parameters include anonymity, possibility to vote messages and limitations on message length.

The first evaluation focus is the \textit{the quantity of participation}. The focus should be both in the uptake and long-term use of the system. The research tradition in this area has focused in examining the impact of background variables into participation, such as socio-economical factors. This research proposal aims to study not only those, but also the impact of the experimental parameters.

The second and third evaluation foci are related \textit{the quality of participation}. This includes both the more objective quality and the subjective experience of participation. The former research aims to quantify qualitative material and evaluate it, where as the latter is more classical qualitative study, aiming to understand how participants feel about the participation, e.g. via interviews.
\end{abstract}
...
Even while there is existing theoretical and (quasi)experimental research (see Table \ref{tab:modalities}), the three different domains discussed above are not examined together, nor has the research applied the deliberative approach. This has also been pointed in \possessivecite{wright12} work. However, as demonstrated in \citeasnoun{margetts09a} and \citeasnoun{margetts09b}, the experimental method can be used to examine interaction caused by different conditions. In this research proposal the conditions are related to the discussion system, e.g.:
