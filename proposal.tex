...
However, less scholarly focus has been on the design of the discussion forums and the implications of design \citeaffixed{wright07}{however, e.g.}. This proposal suggest that these design choices and their impact on the user behaviour should be studied in an experimental setting to understand how to design these forums in an improved way.
